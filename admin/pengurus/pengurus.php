...
<div class="container-fluid">
	<div class="row">
		...
		<h3>
			...
			&nbsp Data Pengurus 
			<a href="#dialog-pengurus" id="0" class="btn btn-primary tambah" data-toggle="modal">
				<i class="icon-plus">Tambah Data </i> 
			</a>
		</h3>

		<!-- tempat untuk menampilkan data pengurus -->
		<div id="data-pengurus"></div>
	</div>

<!-- awal untuk modal dialog -->
<div id="dialog-pengurus" class="modal modal-open modal-dialog modal-content in fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h3 id="myModalLabel">Tambah Data Pengurus</h3>
	</div>
	<!-- tempat untuk menampilkan form pengurus -->
	<div class="modal-body"></div>
	<div class="modal-footer">
		<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Batal</button>
		<button id="simpan-pengurus" class="btn btn-success">Simpan</button>
	</div>
</div>
</div>
