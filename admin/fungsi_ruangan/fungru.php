...
<div class="container-fluid">
	<div class="row">
		...
		<h3>
			...
			&nbsp Data Fungsi Ruangan
			<a href="#dialog-fungru" id="0" class="btn btn-primary tambah" data-toggle="modal">
				<i class="icon-plus">Tambah Data </i> 
			</a>
		</h3>

		<!-- tempat untuk menampilkan data fungru -->
		<div id="data-fungru"></div>
	</div>

<!-- awal untuk modal dialog -->
<div id="dialog-fungru" class="modal modal-open modal-dialog modal-content in fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h3 id="myModalLabel">Tambah Data Fungsi Ruangan</h3>
	</div>
	<!-- tempat untuk menampilkan form fungru -->
	<div class="modal-body"></div>
	<div class="modal-footer">
		<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Batal</button>
		<button id="simpan-fungru" class="btn btn-success">Simpan</button>
	</div>
</div>
</div>
...
<script src="../../js/fungru.js"></script>
