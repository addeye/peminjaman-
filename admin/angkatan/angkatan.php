...
<div class="container-fluid">
	<div class="row">
		...
		<h3>
			...
			Data Angkatan 
			<a href="#dialog-angkatan" id="0" class="btn btn-primary tambah" data-toggle="modal">
				<i class="icon-plus">Tambah Data </i> 
			</a>
		</h3>

		<!-- tempat untuk menampilkan data angkatan -->
		<div id="data-angkatan"></div>
	</div>
</div>
<!-- awal untuk modal dialog -->
<div id="dialog-angkatan" class="modal modal-open modal-dialog modal-content in fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h3 id="myModalLabel">Tambah Data angkatan</h3>
	</div>
	<!-- tempat untuk menampilkan form angkatan -->
	<div class="modal-body"></div>
	<div class="modal-footer">
		<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Batal</button>
		<button id="simpan-angkatan" class="btn btn-success">Simpan</button>
	</div>
</div>
...
<script src="../../js/angkatan.js"></script>
