...
<div class="container-fluid">
	<div class="row">
		...
		<h3>
			...
			&nbsp Data Mata Kuliah 
			<a href="#dialog-thajaran" id="0" class="btn btn-primary tambah" data-toggle="modal">
				<i class="icon-plus">Tambah Data </i> 
			</a>
		</h3>

		<!-- tempat untuk menampilkan data thajaran -->
		<div id="data-thajaran"></div>
	</div>

<!-- awal untuk modal dialog -->
<div id="dialog-thajaran" class="modal modal-open modal-dialog modal-content in fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
		<h3 id="myModalLabel">Tambah Data Tahun Ajaran</h3>
	</div>
	<!-- tempat untuk menampilkan form thajaran -->
	<div class="modal-body"></div>
	<div class="modal-footer">
		<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Batal</button>
		<button id="simpan-thajaran" class="btn btn-success">Simpan</button>
	</div>
</div>
</div>
...
<script src="../../js/thajaran.js"></script>
