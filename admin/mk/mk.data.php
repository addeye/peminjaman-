...
<tbody>
    <?php 
        ...
        $jml_data = mysqli_num_rows(mysqli_query($sqli,"SELECT * from MK"));
        ...
        if(isset($_POST['cari'])) {
            ...
            $query = mysqli_query($sqli," SELECT ID_MK,  KODE_MK,  MATA_KULIAH, SKS FROM mk 
WHERE 
KODE_MK  LIKE '%$kunci%'
OR MATA_KULIAH LIKE '%$kunci%' 
OR SKS  LIKE '%$kunci%' 
        ...
        elseif(isset($_POST['halaman'])) {
            ...
            $query = mysqli_query($sqli,"SELECT ID_MK,  KODE_MK,  MATA_KULIAH, SKS FROM mk LIMIT ".(($halaman - 1) * $jml_per_halaman).", $jml_per_halaman");
...
LIMIT 0,$jml_per_halaman");
    ...
    <tr>
        ...
        <td align="center">
            <a href="#dialog-mk" id="<?=$data['ID_MK'] ?>" class="btn btn-warning ubah" data-toggle="modal">
                <i class="icon icon-pencil ubah"></i> Ubah </a> 
            <a href="#" id="<?php echo $data['ID_MK'] ?>" class="btn btn-danger hapus">
