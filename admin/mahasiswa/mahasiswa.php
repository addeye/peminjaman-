...
<div class="container-fluid">
	<div class="row">
		...
		<h3>
			...
			Data Mahasiswa 
			<a href="#dialog-mahasiswa" id="0" class="btn btn-primary tambah" data-toggle="modal">
...
<div id="dialog-mahasiswa" class="modal modal-open modal-dialog modal-content in fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
