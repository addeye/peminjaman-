...
<tbody>
    <?php 
        ...
        $jml_data = mysqli_num_rows(mysqli_query($sqli,"SELECT * from lantai"));
        ...
        if(isset($_POST['cari'])) {
            ...
            $query = mysqli_query($sqli," SELECT * FROM lantai 
WHERE 
LANTAI  LIKE '%$kunci%'
        ...
        elseif(isset($_POST['halaman'])) {
            ...
            $query = mysqli_query($sqli,"SELECT * FROM lantai LIMIT ".(($halaman - 1) * $jml_per_halaman).", $jml_per_halaman");
...
LIMIT 0,$jml_per_halaman");
    ...
    <tr>
        ...
        <td align="center">
            <a href="#dialog-lantai" id="<?=$data['ID_LANTAI'] ?>" class="btn btn-warning ubah" data-toggle="modal">
                <i class="icon icon-pencil ubah"></i> Ubah </a> 
            <a href="#" id="<?php echo $data['ID_LANTAI'] ?>" class="btn btn-danger hapus">
